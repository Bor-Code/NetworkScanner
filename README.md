...
3. Tarama Başlatma
Sol panelde bilgileri doldurun

"▶ Start Scan" butonuna tıklayın

Sonuçları sağ panelde izleyin

İstatistikler üstte gerçek zamanlı güncellenir
...
Özellik Önerisi
Issues sayfasında "Feature Request" açın

Önerinizi detaylandırın

Kullanım senaryosu yazın

Kod Katkısı
Repoyu fork edin

Yeni branch oluşturun (git checkout -b feature/YeniOzellik)
...
3. Starting a Scan
Fill in the information in the left panel

Click the "▶ Start Scan" button

Watch the results in the right panel
...
Feature Request
Open "Feature Request" on Issues page

Detail your suggestion
...
Create new branch (git checkout -b feature/NewFeature)
